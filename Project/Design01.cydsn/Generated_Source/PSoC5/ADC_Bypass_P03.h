...
void    ADC_Bypass_P03_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the ADC_Bypass_P03_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(ADC_Bypass_P03__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in ADC_Bypass_P03_SetInterruptMode() function.
     *  @{
     */
        #define ADC_Bypass_P03_INTR_NONE      (uint16)(0x0000u)
        #define ADC_Bypass_P03_INTR_RISING    (uint16)(0x0001u)
        #define ADC_Bypass_P03_INTR_FALLING   (uint16)(0x0002u)
        #define ADC_Bypass_P03_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define ADC_Bypass_P03_INTR_MASK      (0x01u) 
#endif /* (ADC_Bypass_P03__INTSTAT) */
...
/* SIO registers */
#if defined(ADC_Bypass_P03__SIO_CFG)
    #define ADC_Bypass_P03_SIO_HYST_EN        (* (reg8 *) ADC_Bypass_P03__SIO_HYST_EN)
    #define ADC_Bypass_P03_SIO_REG_HIFREQ     (* (reg8 *) ADC_Bypass_P03__SIO_REG_HIFREQ)
    #define ADC_Bypass_P03_SIO_CFG            (* (reg8 *) ADC_Bypass_P03__SIO_CFG)
    #define ADC_Bypass_P03_SIO_DIFF           (* (reg8 *) ADC_Bypass_P03__SIO_DIFF)
#endif /* (ADC_Bypass_P03__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define ADC_Bypass_P03_0_INTTYPE_REG 		(* (reg8 *) ADC_Bypass_P03__0__INTTYPE)
#endif /* (ADC_Bypass_P03__INTSTAT) */
