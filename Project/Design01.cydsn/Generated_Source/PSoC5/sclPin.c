...
{
    uint8 staticBits = (sclPin_DR & (uint8)(~sclPin_MASK));
    sclPin_DR = staticBits | ((uint8)(value << sclPin_SHIFT) & sclPin_MASK);
}
...
{
	CyPins_SetPinDriveMode(sclPin_0, mode);
}
...
{
    return (sclPin_PS & sclPin_MASK) >> sclPin_SHIFT;
}
...
{
    return (sclPin_DR & sclPin_MASK) >> sclPin_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(sclPin_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & sclPin_0_INTR) != 0u) 
		{ 
			 sclPin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (sclPin_INTSTAT & sclPin_MASK) >> sclPin_SHIFT;
    }
