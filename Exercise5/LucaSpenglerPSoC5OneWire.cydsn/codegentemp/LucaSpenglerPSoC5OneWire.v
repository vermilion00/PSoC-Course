...
module top ;
	...
	wire [0:0] tmpOE__ledOut_net;
	wire [0:0] tmpFB_0__ledOut_net;
	wire [0:0] tmpIO_0__ledOut_net;
	wire [0:0] tmpINTERRUPT_0__ledOut_net;
	electrical [0:0] tmpSIOVREF__ledOut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ledOut
		 (.oe(tmpOE__ledOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledOut_net[0:0]}),
		  .io({tmpIO_0__ledOut_net[0:0]}),
		  .siovref(tmpSIOVREF__ledOut_net),
		  .interrupt({tmpINTERRUPT_0__ledOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__onewire_pin_net;
	wire [0:0] tmpFB_0__onewire_pin_net;
	wire [0:0] tmpINTERRUPT_0__onewire_pin_net;
	electrical [0:0] tmpSIOVREF__onewire_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		onewire_pin
		 (.oe(tmpOE__onewire_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__onewire_pin_net[0:0]}),
		  .io({Net_115}),
		  .siovref(tmpSIOVREF__onewire_pin_net),
		  .interrupt({tmpINTERRUPT_0__onewire_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__onewire_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
