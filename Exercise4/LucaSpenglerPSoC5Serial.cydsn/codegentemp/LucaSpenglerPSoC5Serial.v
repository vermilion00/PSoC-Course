// ======================================================================
// LucaSpenglerPSoC5Serial.v generated from TopDesign.cysch
// 04/11/2024 at 15:41
...
module I2C_v3_50_2 (
	...
	cy_clock_v1_0
		#(.id("a82ddccb-2909-4e9f-9f4e-e57003ccbb6c/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
// SPI_Master_v2_50(BidirectMode=false, ClockInternal=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DesiredBitRate=1200000, HighSpeedMode=false, InternalClockUsed=1, InternalInterruptEnabled=0, InternalRxInterruptEnabled=0, InternalTxInterruptEnabled=1, InterruptOnByteComplete=true, InterruptOnRXFull=false, InterruptOnRXNotEmpty=false, InterruptOnRXOverrun=false, InterruptOnSPIDone=false, InterruptOnSPIIdle=false, InterruptOnTXEmpty=false, InterruptOnTXNotFull=false, IntOnByteComp=1, IntOnRXFull=0, IntOnRXNotEmpty=0, IntOnRXOver=0, IntOnSPIDone=0, IntOnSPIIdle=0, IntOnTXEmpty=0, IntOnTXNotFull=0, Mode=1, ModeUseZero=1, NumberOfDataBits=15, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, RxBufferSize=4, ShiftDir=0, TxBufferSize=4, UseInternalInterrupt=false, UseRxInternalInterrupt=false, UseTxInternalInterrupt=true, VerilogSectionReplacementString=sR16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SPI_Master_v2_50, CY_CONFIG_TITLE=SPIM_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SPIM_1, CY_INSTANCE_SHORT_NAME=SPIM_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SPIM_1, )
module SPI_Master_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("8aee93ca-28fa-4793-b841-532959daa726/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    defparam BSPIM.NumberOfDataBits = 15;
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e3a73439-e280-4ff3-ad12-4a8c59b39884"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam SPIM_1.NumberOfDataBits = 15;
    defparam SPIM_1.ShiftDir = 0;

	wire [0:0] tmpOE__miso_pin_net;
	wire [0:0] tmpIO_0__miso_pin_net;
	wire [0:0] tmpINTERRUPT_0__miso_pin_net;
	electrical [0:0] tmpSIOVREF__miso_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("32a66462-2751-44cf-afa0-9611dadd5f1b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		miso_pin
		 (.oe(tmpOE__miso_pin_net),
		  .y({1'b0}),
		  .fb({Net_130}),
		  .io({tmpIO_0__miso_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__miso_pin_net),
		  .interrupt({tmpINTERRUPT_0__miso_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__miso_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sclk_pin_net;
	wire [0:0] tmpFB_0__sclk_pin_net;
	wire [0:0] tmpIO_0__sclk_pin_net;
	wire [0:0] tmpINTERRUPT_0__sclk_pin_net;
	electrical [0:0] tmpSIOVREF__sclk_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("f9fed5e5-43a4-40e6-82ca-5c773c934b38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		sclk_pin
		 (.oe(tmpOE__sclk_pin_net),
		  .y({Net_128}),
		  .fb({tmpFB_0__sclk_pin_net[0:0]}),
		  .io({tmpIO_0__sclk_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__sclk_pin_net),
		  .interrupt({tmpINTERRUPT_0__sclk_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sclk_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_pin_net;
	wire [0:0] tmpFB_0__cs_pin_net;
	wire [0:0] tmpIO_0__cs_pin_net;
	wire [0:0] tmpINTERRUPT_0__cs_pin_net;
	electrical [0:0] tmpSIOVREF__cs_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("60b5a8f1-950f-44ac-bdc1-99db364ce2a9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cs_pin
		 (.oe(tmpOE__cs_pin_net),
		  .y({Net_129}),
		  .fb({tmpFB_0__cs_pin_net[0:0]}),
		  .io({tmpIO_0__cs_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_pin_net),
		  .interrupt({tmpINTERRUPT_0__cs_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
